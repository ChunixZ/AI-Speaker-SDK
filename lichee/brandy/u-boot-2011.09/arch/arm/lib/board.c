...
extern int axp22_set_dcdc1(int set_vol, int onoff);
...
//	int ret_led;
	...
	data = 0xFF;
	i2c_write(0x3f, 0x4f, 1, &data, 1);
//	ret_led=i2c_write(0x3f, 0x4f, 1, &data, 1);
	//printf("============ jeffrey_led:ret_led_1=%d\n",ret_led);
	udelay(1000);

	data = 0x00;
	i2c_write(0x3f, 0x4a, 1, &data, 1);
	udelay(1000);

	data = 0x01;
	i2c_write(0x3f, 0x00, 1, &data, 1);
	udelay(1000);

	data = 0x01;
	i2c_write(0x3f, 0x25, 1, &data, 1);
	udelay(1000);

	for(led_i=0;led_i<12;led_i++){
		data = 0xFF;
		i2c_write(0x3f, 1+led_i*3, 1, &data, 1);
		udelay(1000);

		data = 0x00;
		i2c_write(0x3f, 2+led_i*3, 1, &data, 1);
		udelay(1000);

		data = 0x00;
		i2c_write(0x3f, 3+led_i*3, 1, &data, 1);
		udelay(1000);

		data = 0x01;
		i2c_write(0x3f, 38+led_i*3, 1, &data, 1);
		udelay(1000);

		data = 0x00;
		i2c_write(0x3f, 39+led_i*3, 1, &data, 1);
		udelay(1000);

		data = 0x00;
		i2c_write(0x3f, 40+led_i*3, 1, &data, 1);
		udelay(1000);
