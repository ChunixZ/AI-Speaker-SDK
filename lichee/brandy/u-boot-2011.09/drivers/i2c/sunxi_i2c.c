...
void i2c_init(int speed, int slaveaddr)
{
	...
	uint32_t fl3236_led = 0;
	fl3236_led = gpio_request_ex("fl3236_led_para", "fl3236_led_shut");
    if(fl3236_led == 0){
        printf("ERR: gpio_request failed\n");
    }
    gpio_set_one_pin_io_status(fl3236_led, 1, NULL);
    gpio_write_one_pin_value(fl3236_led, 1, NULL);
